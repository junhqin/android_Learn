...
import com.synu.neteasedemo.domain.NewInfo;
...
public class MainActivity extends Activity {
    ...
    public void showInfo(){
        ...
        .setPositiveButton("关注", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
            	Toast.makeText(MainActivity.this, "感谢您关注本条新闻！", Toast.LENGTH_LONG).show();
            }
        }).setNegativeButton("不关注", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				Toast.makeText(MainActivity.this, "欢迎点击查看其它新闻!", Toast.LENGTH_LONG).show();
			}
		})
        .show();
	...
	private List<NewInfo> getNewsFromInternet() {
		...
		try {
			...
			// 定义get方法
			HttpGet get = new HttpGet("http://58.154.51.100:8080/EasyNewsClient/news.xml");
